...
TooltipObject.SliceCenter = Rect.new(
	TOOLTIP_BORDER_RADIUS,
	TOOLTIP_BORDER_RADIUS,
	256 - TOOLTIP_BORDER_RADIUS,
	256 - TOOLTIP_BORDER_RADIUS
)
	...
	Init = function(self)
		...
		function self.InputBegan(InputObject)
			...
			if Signal then
				...
				if self.Style == Enumeration.ButtonStyle.Contained and self.CanBeRaised then
			...
			elseif InputObject.UserInputType == MouseMovement then
				...
				if self.Style == Enumeration.ButtonStyle.Contained then
					Tween(
						self.Object,
						"ImageColor3",
						self.PrimaryColor3:Lerp(self.Rippler.RippleColor3, self.OverlayOpacity),
						Enumeration.EasingFunction.Deceleration,
						0.1,
						true
					)
				else
					...
					delay(0.5, function()
						if NewInt == Int then
							Tween(
								TooltipObj,
								"Size",
								UDim2.new(0, TooltipObj.TextLabel.TextBounds.X + 16, 0, 24),
								Enumeration.EasingFunction.Deceleration,
								0.1,
								true
							)
