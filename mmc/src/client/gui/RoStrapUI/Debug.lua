...
do
	...
	Debug.TableToString = Typer.AssignSignature(
		Typer.Table,
		Typer.OptionalBoolean,
		Typer.OptionalString,
		function(Table, Multiline, TableName)
...
do
	...
	Debug.EscapeString = Typer.AssignSignature(Typer.String, function(String)
		...
		return (String:gsub(Escapable, "%%%1"):gsub("([\"'\\])", "\\%1"))
	end)
end
