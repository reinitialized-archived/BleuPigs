...
local Tween = {
	__index = {
		...
		LerpFunction = function(StartValue, EndValue, Alpha)
			return EndValue
		end,
	},
}
...
Tween.new = Typer.AssignSignature(
	Typer.OptionalNumber,
	Typer.OptionalFunctionOrEnumerationOfTypeEasingFunction,
	Typer.FunctionOrTableOrUserdata,
	Typer.Any,
	function(Duration, EasingFunction, Callback, Arg)
		Duration = Duration or 1
		EasingFunction = type(EasingFunction) == "userdata" and EasingFunctions[EasingFunction.Value]
			or EasingFunction
			or Linear
...
return Table.Lock(
	...
	Typer.AssignSignature(
		...
		Typer.OptionalFunctionOrTableOrUserdataOrTrue,
		Typer.Any,
		function(_, Object, Property, EndValue, EasingFunction, Duration, Override, Callback, CallbackArg)
			Duration = Duration or 1
