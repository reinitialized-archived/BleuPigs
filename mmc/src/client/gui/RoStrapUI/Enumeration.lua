...
local function ConstructUserdata(__index, __newindex, __tostring)
	...
	EnumerationMetatable.__tostring = function()
		return __tostring
	end
...
local MakeEnumeration = Typer.AssignSignature(
	2,
	Typer.String,
	Typer.ArrayOfStringsOrDictionaryOfNumbers,
	function(_, EnumType, EnumTypes)
		if rawget(Enumerations, EnumType) then
			Debug.Error("Enumeration of EnumType " .. EnumType .. " already exists")
		end
